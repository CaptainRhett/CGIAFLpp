...
function PageInit(){
    ...
    btnModifyPolicy.onclick = function() {
        ...
        if (parseInt(document.getElementById("_nm_power_limit").value) > 65535) {
            alert(lang.LANG_MISC_NM_CONFIG_ERR2);
            return;
        }
...
function writePolicy() {
    ...
    var config_action = "1";
    requestWritePolicyInfo(policy_id, "0", isEnable, isShutdown, isLogEvent, power_limit, config_action);
}
