    ...
    Websock.prototype = {
        ...
        flush: function () {
            ...
            if (this._websocket.bufferedAmount < this.maxBufferedAmount) {
                if (this._sQ.length > 0) {
                    //console.log("websock.flush() bufferedAmout: " + this._websocket.bufferedAmount
                    // 			+ ", sQ[0]: " + this._sQ[0]
                    // 			+ ", len: " + this._sQ.length);
        ...
        open: function (uri, protocols) {
            ...
            if (uri.search('websockify') < 0) {
                this._websocket = new WebSocket(uri , "binary");
                protocols = ('binary');
            } else {
            ...
            if (this._websocket == null) {
                Util.Error("new websocket failed");
            }
        ...
        close: function () {
            ...
            if (this._websocket) {
                ...
                this._websocket.onmessage = function (e) { "use strict"; return; };
            }
        },
