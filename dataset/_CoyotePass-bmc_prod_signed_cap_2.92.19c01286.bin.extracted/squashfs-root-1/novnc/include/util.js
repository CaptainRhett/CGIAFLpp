"use strict";
/*
 * iKVM_over_HTML5: HTML5 iKVM client
...
Util.init_logging = function (level) {
    ...
    if (typeof window.console === "undefined") {
        if (typeof window.opera !== "undefined") {
            ...
            window.console = {
                'log'  : function (m) { "use strict"; },
                'warn' : function (m) { "use strict"; },
                'error': function (m) { "use strict"; }
            };
        }
    }
    Util.Debug = Util.Info = Util.Warn = Util.Error = function (msg) { "use strict"; };
    /* jshint -W086 */
    switch (level) {
        case 'debug':
            Util.Debug = function (msg) {
                "use strict";
                if (Util._log_filter) {
                    if (msg.search(Util._log_filter) >= 0) {
                        console.log(msg);
                    }
                } else {
                    console.log(msg);
        ...
        case 'info':
            Util.Info  = function (msg) { "use strict"; console.log(msg); };
        case 'warn':
            Util.Warn  = function (msg) { "use strict"; console.warn(msg); };
        case 'error':
            Util.Error = function (msg) { "use strict"; console.error(msg); };
        case 'none':
            break;
        default:
...
Util.make_property = function (proto, name, mode, type) {
    ...
    if (type === 'bool') {
        ...
        setter = make_setter(function (val) { "use strict"; return parseInt(val, 10); });
    } else if (type === 'float') {
